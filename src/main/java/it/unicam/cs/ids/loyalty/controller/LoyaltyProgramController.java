...
public class LoyaltyProgramController {
	...
	@PostMapping
	public ResponseEntity<LoyaltyProgram> createLoyaltyProgram(@RequestParam String programName,
			@RequestParam String description, @RequestParam boolean isCoalition, @RequestParam int merchantId) {
		LoyaltyProgram loyaltyProgram = merchantService.createLoyaltyProgram(programName, description, isCoalition,
				merchantId);
